python -m deprl.play\
	--header 'import tonic.torch; from deprl import custom_agents; custom_agents;import gym;import warmup;'\
	--env "tonic.environments.Gym('humanreacher-v0', scaled_actions=False)" \
