...
from deprl.vendor.tonic import explorations, replays  # noqa
...
class DDPG(Agent):
    ...
    def __init__(
        ...
        self.actor_updater = (
            actor_updater or updaters.DeterministicPolicyGradient()
        )
        self.critic_updater = (
            critic_updater or updaters.DeterministicQLearning()
        )
